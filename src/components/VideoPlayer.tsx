...
const VideoPlayer = () => {
  useEffect(() => {
    ...
    script.src = "https://scripts.converteai.net/d0d64cb2-dca3-4be6-983c-3bc700b6a1d8/players/697e56d4dfb1c6d43627ade7/v4/player.js";
    script.async = true;
      ...
      <div className="video-container-wrapper w-[85%] md:w-full mx-auto">
        ...
        <div 
          dangerouslySetInnerHTML={{
            __html: `<vturb-smartplayer id="vid-697e56d4dfb1c6d43627ade7" style="display: block; margin: 0 auto; width: 100%; max-width: 100%;"></vturb-smartplayer>`
          }}
        />
